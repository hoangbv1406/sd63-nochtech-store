...
import com.project.shopapp.domains.payment.vnpay.VNPayConfig;
import com.project.shopapp.domains.payment.vnpay.VNPayUtils;
...
public class VNPayServiceImpl implements VNPayService {
    ...
    @Override
    public String queryTransaction(PaymentQueryDTO queryDto, HttpServletRequest httpRequest) throws IOException, java.io.IOException {
        ...
        String hashData = String.join("|", requestId, version, command, terminalCode, transactionReference, transactionDate, createDate, clientIpAddress, "Check transaction");
    ...
    public String refundTransaction(PaymentRefundDTO refundRequest) throws IOException, java.io.IOException {
        String requestId = vnPayUtils.getRandomNumber(8);
        String version = "2.1.0";
